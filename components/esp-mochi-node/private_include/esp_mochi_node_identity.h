...
#define ESP_MOCHI_NODE_ED25519_SEED_LEN              32
#define ESP_MOCHI_NODE_ED25519_PUBLIC_KEY_LEN        32
#define ESP_MOCHI_NODE_ED25519_PRIVATE_KEY_LEN       64
#define ESP_MOCHI_NODE_DEVICE_ID_HEX_LEN             64
#define ESP_MOCHI_NODE_PUBLIC_KEY_B64URL_LEN         43
#define ESP_MOCHI_NODE_SIGNATURE_B64URL_LEN          86
#define ESP_MOCHI_NODE_PUBLIC_KEY_B64_ENCODED_LEN    44
#define ESP_MOCHI_NODE_SIGNATURE_B64_ENCODED_LEN     88
#define ESP_MOCHI_NODE_PUBLIC_KEY_B64_BUFFER_LEN     (ESP_MOCHI_NODE_PUBLIC_KEY_B64_ENCODED_LEN + 1)
#define ESP_MOCHI_NODE_SIGNATURE_B64_BUFFER_LEN      (ESP_MOCHI_NODE_SIGNATURE_B64_ENCODED_LEN + 1)

/** @brief Persisted and derived device identity state. */
typedef struct {
    uint8_t seed[ESP_MOCHI_NODE_ED25519_SEED_LEN];                  /**< Ed25519 seed stored in NVS. */
    uint8_t public_key[ESP_MOCHI_NODE_ED25519_PUBLIC_KEY_LEN];     /**< Derived public key bytes. */
    uint8_t private_key[ESP_MOCHI_NODE_ED25519_PRIVATE_KEY_LEN];   /**< Derived private key bytes. */
    char device_id[ESP_MOCHI_NODE_DEVICE_ID_HEX_LEN + 1];          /**< Stable hex device identifier. */
    char public_key_b64url[ESP_MOCHI_NODE_PUBLIC_KEY_B64_BUFFER_LEN]; /**< Base64url-encoded public key. */
} esp_mochi_node_identity_t;
 ...
 */
esp_err_t esp_mochi_node_identity_load_or_create(esp_mochi_node_identity_t *identity);

/**
 * @brief Persist a caller-provided Ed25519 seed when no identity exists yet.
 *
 * This helper provisions the seed used by @ref esp_mochi_node_identity_load_or_create
 ...
 *        @ref ESP_MOCHI_NODE_ED25519_SEED_LEN.
 *
 * @return
 *      - `ESP_OK` on success
 ...
 */
esp_err_t esp_mochi_node_identity_store_seed_if_absent(const uint8_t *seed, size_t seed_len);
 ...
 */
void esp_mochi_node_identity_free(esp_mochi_node_identity_t *identity);
 ...
 */
esp_err_t esp_mochi_node_identity_sign_payload(
    const esp_mochi_node_identity_t *identity,
    const char *payload,
 ...
 */
esp_err_t esp_mochi_node_identity_build_auth_payload_v3(
    const esp_mochi_node_identity_t *identity,
