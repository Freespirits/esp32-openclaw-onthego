...
#define ESP_MOCHI_NODE_BOX_DISPLAY_MAX_HEADING_LEN 64
/** @brief Maximum UTF-8 body length accepted by `display.show`. */
#define ESP_MOCHI_NODE_BOX_DISPLAY_MAX_TEXT_LEN 512
...
typedef struct {
    ...
    char heading[ESP_MOCHI_NODE_BOX_DISPLAY_MAX_HEADING_LEN + 1]; /**< Last rendered heading text. */
    char text[ESP_MOCHI_NODE_BOX_DISPLAY_MAX_TEXT_LEN + 1]; /**< Last rendered body text. */
