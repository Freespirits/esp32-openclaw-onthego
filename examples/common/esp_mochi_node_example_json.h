 ...
 *
 * @param[in] params_json UTF-8 JSON params from the Mochi command request.
 ...
 */
esp_err_t esp_mochi_node_example_parse_json_params(
 ...
 */
esp_err_t esp_mochi_node_example_take_json_payload(
    cJSON *payload,
