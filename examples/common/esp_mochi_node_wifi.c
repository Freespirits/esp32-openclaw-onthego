...
static const char *TAG = "esp_mochi_node_wifi";

static EventGroupHandle_t s_wifi_events;
static SemaphoreHandle_t s_wifi_lock;
static esp_mochi_node_wifi_status_t s_status;
...
esp_err_t esp_mochi_node_wifi_start(void)
{
    if (s_started) {
        return ESP_OK;
    }
...
esp_err_t esp_mochi_node_wifi_set_credentials(const char *ssid, const char *passphrase)
{
...
esp_err_t esp_mochi_node_wifi_clear_credentials(void)
{
    if (!s_started || s_wifi_lock == NULL) {
        return ESP_ERR_INVALID_STATE;
    }
...
esp_err_t esp_mochi_node_wifi_connect(void)
{
    if (!s_started || s_wifi_lock == NULL) {
        return ESP_ERR_INVALID_STATE;
    }
...
esp_err_t esp_mochi_node_wifi_disconnect(void)
{
    if (!s_started || s_wifi_lock == NULL) {
        return ESP_ERR_INVALID_STATE;
    }
...
bool esp_mochi_node_wifi_wait_for_connection(TickType_t timeout_ticks)
{
    if (s_wifi_events == NULL) {
        return false;
    }
...
bool esp_mochi_node_wifi_is_connected(void)
{
    if (s_wifi_lock == NULL) {
        return false;
    }
...
void esp_mochi_node_wifi_get_status(esp_mochi_node_wifi_status_t *status)
{
    if (status == NULL) {
        return;
    }
