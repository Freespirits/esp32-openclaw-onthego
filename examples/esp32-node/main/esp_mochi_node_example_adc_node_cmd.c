...
#include "esp_mochi_node_example_adc_node_cmd.h"
...
} esp_mochi_node_example_adc_context_t;

static const char *TAG = "esp_mochi_node_adc";
static esp_mochi_node_example_adc_context_t s_adc;

static esp_err_t ensure_adc_channel(
    esp_mochi_node_example_adc_context_t *context,
    ...
    esp_mochi_node_error_t *out_error)
{
    ...
    esp_mochi_node_example_adc_context_t *adc = (esp_mochi_node_example_adc_context_t *)context;
    cJSON *params = NULL;
    ESP_RETURN_ON_ERROR(
...
esp_err_t esp_mochi_node_example_register_adc_node_commands(esp_mochi_node_handle_t node)
{
    static const esp_mochi_node_command_t ADC_READ_COMMAND = {
        .name = "adc.read",
    ...
    ESP_RETURN_ON_ERROR(
        esp_mochi_node_register_capability(node, "adc"),
        TAG,
        "registering adc capability failed");
    ESP_RETURN_ON_ERROR(
        esp_mochi_node_register_command(node, &ADC_READ_COMMAND),
        TAG,
